...
area = int(input('Площадь квартиры, в кв. м.: '))
cost = int(input('Стоимость квартиры, в млн. руб.: '))
if (area >= 100 and cost <= 10) or (area > 80 and cost <= 7):
    print('Квартира нам подходит!')
else:
    print('Продолжаем поиски...')