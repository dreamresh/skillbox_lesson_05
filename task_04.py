...
print('С операторами')
place_in_line = int(input('Введите место в списке поступающих: '))
points = int(input('Введите количество баллов за экзамены: '))
if place_in_line <= 10 and points >= 290:
    print('Поздравляем, Вы поступили! \nБонусом Вам будет начисляться стипендия')
elif place_in_line <= 10 and points < 290:
    print('Поздравляем, Вы поступили! \nНо Вам не хватило баллов для стипендии')
else:
    print('К сожалению, места закончились.')

print('Без операторов')
place_in_line = int(input('Введите место в списке поступающих: '))
points = int(input('Введите количество баллов за экзамены: '))
if place_in_line <= 10:
    if points >= 290:
